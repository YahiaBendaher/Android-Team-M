...
import edu.polytech.filrouge_teamM.report.observer.IssueObservable;
import edu.polytech.filrouge_teamM.report.observer.IssueObserver;
...
public abstract class Issue implements Parcelable, IssueObservable {
    ...
    public void setPriorityRating(float rating) {
        this.priorityRating = rating;
        Priority newPriority = priorityFromRating(rating);
    ...
    public void setPriority(Priority priority) {
        if (this.priority != priority) {
            this.priority = priority;
            this.priorityRating = priority.getRating();
            updatePriorityImage();
            notifyPriorityChanged();
        }
    }
